      ...
      >
         ...
         <Paragraph lineHeight={lineHeightProp}>
            <TextLine>
                ...
                The base of every triangular face coincides with a side of the polygonal base,
                 and opposite vertices of the triangle meet at a common point called the{" "}
                <TextSpanBg
               onHover={() => onHover(1)}
            ...
            <TextLine>
               ...
               hoverColor={colors.DARK_LAVENDER}
            >altitude</TextSpanBg>{" "}
                 or height of the pyramid is the perpendicular distance from the apex to the center of the base.
            </TextLine>
            <TextLine>
                <MathElement htmlString={latex[mathjaxCounter]} />&nbsp;
                <TextSpanBg
               ...
               onHoverOut={onHoverOut}
               hoverColor={colors.DARK_LAVENDER}
            >Slant height</TextSpanBg> is the length of the perpendicular drawn to the base of the side face of a triangle from the apex.
            </TextLine>
         </Paragraph>
      </TextAndDiagramSlide>
   );
