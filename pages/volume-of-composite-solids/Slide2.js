  ...
  const modalContent = (
    <Flex direction="column">
      <Paragraph color="white" marginBottom="1vh">
        The three-dimensional solids or objects in geometry are solid figures that have three dimensions, length (l), width (w), and height (h).
      </Paragraph>
      <ModalImg src={i1} alt="Diagram of a rectangular prism with length l, width w and height h." />
    </Flex>
  );
  return null;
};
