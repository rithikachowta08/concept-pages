...
const Slide6 = ({ downIcon }) => {
  return (
    ...
    >
      <Paragraph>
        &bull; Standard units can be represented using fixed values and numbers.{" "}
      </Paragraph>
      <Paragraph>
        &bull; Standard units are predefined and do not change from person to
        person.{" "}
      </Paragraph>
      <Paragraph>
        &bull; Unit conversion in standard units is possible.{" "}
      </Paragraph>
    </TextAndDiagramSlide>
  );
};
