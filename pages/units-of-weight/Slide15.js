...
const Slide14 = ({ downIcon }) => {
   return (
      ...
      >
         <Paragraph>
         The Imperial System includes grain, dram, stone, quarter, hundredweight and long ton as additional units to measure mass apart from ounce, pound and ton in the US system.
         </Paragraph>
      </TextAndDiagramSlide>
   );
};
