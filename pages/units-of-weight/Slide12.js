...
const sides_shaded =
   "assets/units-of-weight/slide12/2.svg";
const all_sides_shaded =
   "assets/units-of-weight/slide12/3.svg";
...
const Slide11 = ({ downIcon }) => {
   ...
   return (
      ...
      >
         <Paragraph>
         Mass is measured using the SI unit called kilogram (kg). In the SI system, designations of
         {" "}<TextSpanBg
                  id={1}
                  onHover={onHover}
               ...
               >
                 subdivisions
               </TextSpanBg>{" "}of mass are determined by combining “gram” with the metric number prefixes.
         </Paragraph>.
      </TextAndDiagramSlide>
   );
};
