...
const sides_shaded =
   "assets/units-of-weight/slide11/2.svg";
...
const Slide10 = ({ downIcon }) => {
   ...
   return (
      ...
      >
         <Paragraph>
         In the SI system, designations of multiples or subdivisions of any unit are determined by combining the name of the unit with the 
         {" "}<TextSpanBg
                  id={1}
                  onHover={onHover}
