...
const Slide11 = ({navBar,downIcon}) => {
  ...
  hint:'(Neglect -ve Value)'
    ...
    },
    {
      ...
      rhsLatex:[
        {
          eqLatex:"s^3= \\frac{d^3}{3\\sqrt{3}} = \\frac{\\sqrt{3} d^3}{9}",
        hint:''
      },
    ]
    },
  ...
  return (
    <TextAndDiagramSlide
      ...
      downIcon={downIcon} navBar={navBar}>
      <Paragraph>
        <TextLine>
        In
        <TextSpanBg
        ...
        <MultiLhsEquationContainer lineHeight="1.5" color={colors.BLACK} equationLatex={eq1Latex}>
        ...
        <MultiLhsEquationContainer equationLatex={eq2Latex}>
        </MultiLhsEquationContainer>
        </Paragraph>
        <Paragraph>
          <MultiLhsEquationContainer equationLatex={eq3Latex}>
