...
const highlighting_sector = "assets/length-of-arc-of-a-circle/highlighting_sector.svg";
const highlighting_radii = "assets/length-of-arc-of-a-circle/highlighting_radii.svg";
const highlighting_arc = "assets/length-of-arc-of-a-circle/highlighting_arc.png";
...
const Slide5 = ({ downIcon, navBar }) => {
  ...
  return (
    <TextAndDiagramSlide
      ...
      diagram={
        <TransitionImage
          images={[sector, highlighting_sector, highlighting_radii,highlighting_arc]}
          altTexts={[
