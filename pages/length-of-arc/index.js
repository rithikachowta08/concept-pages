...
const LengthOfArcOfACircle = () => {
   const SlideArray = [
      ...
      <Slide14 key={13} type={SLIDE_TYPES.VIDEO_ONLY} />,
      <PageLastSlide
...
LengthOfArcOfACircle.title =
   "Length of Arc of a circle: Definition, Formula, Examples - BYJU'S";
LengthOfArcOfACircle.meta =
   "Discover the concept of length of arc of a circle, including its definition, formula, and examples. Enhance your understanding with BYJU'S interactive activities and examples.";
