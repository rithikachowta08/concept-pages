...
import down_caret_light from "assets/down_caret.svg";
import up_caret_light from "assets/up_caret_light.svg";
          ...
          <Flex
            ...
            {sections.map((section, idx) => (
              <Flex
                ...
                />
                <TextSpan color={darkTheme ? colors.WHITE : colors.BLACK}>{section.title}</TextSpan>
              </Flex>
            ))}
          </Flex>
        ) : (
