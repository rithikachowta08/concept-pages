...
import left_caret_dark from "assets/left_caret.svg";
import left_caret_light from "assets/left_caret_light.svg";
    ...
    <NavWrap
      ...
      {isExpanded ? (
        <Flex
          ...
          alignItems="center"
          marginBottom="40px">
          <Icon src={darkTheme ? left_caret_light : left_caret_dark}></Icon>
          <TextSpan
            cursor="pointer"
            marginLeft="20px"
